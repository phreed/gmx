...
// -*-as-*-
// IGMX_Connector.as: Auto generated
// $Rev$: $Date$

package 
{

	public interface IGMX_Connector
	{
		...
		//
		function ISISLayout(a_Layout:String):void;
		
		//
		function ISISRecord(a_RecordList:Array /*RecordVO*/):void;
		
		//
		function ISISCollection(a_CollectionList:Array /*CollectionVO*/):void;
		
		//
		function ISISAttributes(a_AttributeList:Array /*AttributeVO*/):void;
