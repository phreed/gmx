package generics 
{
	 ...
	 */
	public class TextArea_X extends TextArea implements IField
	{
		...
		public function set fid(val:String):void {
			...
			this.addEventListener(FlexEvent.ENTER, GMXComponentListeners.textAreaCallback);
			this.addEventListener(FocusEvent.FOCUS_OUT, GMXComponentListeners.textAreaFocusOutCallback);
		}
